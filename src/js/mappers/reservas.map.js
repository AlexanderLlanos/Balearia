export const reservasMap = {
  toDomain: (response) => {
    return {
      ...
      contactData: response.reserva.contact_data,
      changeTrip: response.reserva.change_trip,
      passengerManagement: response.reserva.passenger_management,
      petsManagement: response.reserva.pets_management,
      vehicleManagement: response.reserva.vehicle_management,
      extrasServiceManagement: response.reserva.extras_service_management,
    };
  },
};
